				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							...
							<div class="col-lg-12">							
								<?php
								$id_order_edit=$_GET['id_order'];
								$total_order=$_GET['id_total'];
								$data_cal = date("Y-m-d");

								include "connect.php";
								$sql2="update tb_order set total_order='$total_order' , date_order='$data_cal' where id_order ='$id_order_edit' and id_name_order='$_SESSION[id]' ";
